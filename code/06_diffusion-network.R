...
V(net)$color <- ifelse(V(net)$agency_level == "City", grey[3],
                ...
                ifelse(V(net)$agency_level == "Federal", grey[6], clr[5]))))))) # why doesnt this work
...
V(state.net)$color <- ifelse(V(state.net)$agency_level == "City", grey[3],
                ...
                ifelse(V(state.net)$agency_level == "Federal", grey[6],clr[5]))))))) # why doesnt this work
...
V(region.net)$color <- ifelse(V(region.net)$agency_level == "City", grey[3],
                       ...
                       ifelse(V(region.net)$agency_level == "Federal", grey[6],clr[5]))))))) # why doesnt this work
...
V(county.net)$color <- ifelse(V(county.net)$agency_level == "City", grey[3],
                       ...
                       ifelse(V(county.net)$agency_level == "Federal", grey[6],clr[5]))))))) # why doesnt this work
